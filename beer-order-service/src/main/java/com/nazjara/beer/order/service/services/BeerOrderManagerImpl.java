...
public class BeerOrderManagerImpl implements BeerOrderManager {
    ...
    public void processValidationResult(UUID beerOrderId, Boolean isValid) {
        ...
        beerOrderOptional.ifPresentOrElse(beerOrder -> {
            if (isValid) {
                ...
                var validatedOrder = beerOrderRepository.findById(beerOrderId).get();
    ...
    public void beerOrderAllocationPassed(BeerOrderDto beerOrderDto) {
        var beerOrderOptional = beerOrderRepository.findById(beerOrderDto.getId());
    ...
    private void updateAllocatedQty(BeerOrderDto beerOrderDto) {
        var allocatedOrderOptional = beerOrderRepository.findById(beerOrderDto.getId());
    ...
    public void beerOrderPickedUp(UUID id) {
        var beerOrderOptional = beerOrderRepository.findById(id);

        beerOrderOptional.ifPresentOrElse(beerOrder -> sendBeerOrderEvent(beerOrder,
                BeerOrderEventEnum.BEER_ORDER_PICKED_UP), () -> log.error("Order Not Found. Id: " + id));
    }
    ...
    private void sendBeerOrderEvent(BeerOrder beerOrder, BeerOrderEventEnum eventEnum) {
        ...
        var message = MessageBuilder.withPayload(eventEnum)
    ...
    private StateMachine<BeerOrderStatusEnum, BeerOrderEventEnum> build(BeerOrder beerOrder) {
        ...
        stateMachine.getStateMachineAccessor()
                .doWithAllRegions(stateMachineAccess -> {
                    ...
                    stateMachineAccess.resetStateMachine(new DefaultStateMachineContext<>(beerOrder.getOrderStatus(), null, null, null));
                });
